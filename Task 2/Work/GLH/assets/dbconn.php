...
function dbconnect_insert(){
    ...
    $dbusername = "admin"; // had to change this variable name as it fought against the admin reg and user reg

    $dbpassword = "A";  //password for database useraccount

    $dbname = "glh";  //database name to connect to
    ...
    try {  //attempt this block of code, catching an error
        ...
        error_log("Database error in super_checker: " . $e->getMessage()); # forms the error message
        // Throw the exception
...
function dbconnect_delete(){
    ...
    $dbusername = "dbdelete"; // had to change this variable name as it fought against the admin reg and user reg

    $dbpassword = "l23)Wrkm7hqvs8c5";  //password for database useraccount
