...
if($_SERVER["REQUEST_METHOD"] === "POST") {
    //$_SESSION["usermessage"] = only_user(dbconnect_insert(), $_POST["username"]){
        ...
        if (reg_puser(dbconnect_insert(), $_POST )) {
...
echo "<input type='text' name='email' id='ProducerID' placeholder='Enter your email.' required>"; # asks for user email
echo "<br>";
